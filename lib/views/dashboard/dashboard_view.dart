...
class DashboardView extends StatelessWidget {
          ...
          children: [
            ...
            if (isDesktop)
              Container(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.eco_rounded, color: Color(0xFFFFC107), size: 20),
                    SizedBox(width: 8),
                    Text(
                      "Administrator Mode",
                      style: TextStyle(
  ...
  Widget _buildFilterSection(
    ...
    return Wrap(
      ...
      children: [
        ...
        _buildFilterButton(controller, "Last 7 Days"),
            ...
            belowBarData: BarAreaData(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  ...
                  const Color(0xFF2D5016).withValues(alpha:0.05),
                ],
              ),
            ),
          ),
  ...
  // === INTERACTIVE PIE CHART ===
   // === INTERACTIVE PIE CHART (FIXED LAYOUT) ===
  Widget _buildPieChart(Map<String, double> data, List<Color> colors) {
    ...
    return StatefulBuilder(
      builder: (context, setState) {
        ...
        return Row(
          children: [
            // 1. CHART SECTION (Takes 60% of space now)
            Expanded(
              flex: 3, 
              child: PieChart(
                PieChartData(
                  ...
                  // Reduce radius slightly to ensure it fits well
                  sections: data.entries.map((e) {
                    final isTouched = i == touchedIndex;
                    final color = colors[i % colors.length];
                    final radius = isTouched ? 60.0 : 50.0; // Adjusted sizes
            ...
            // 2. LEGEND SECTION (Takes 40% of space)
            Expanded(
              flex: 2,
              child: Center( // Centers the list vertically
                child: SingleChildScrollView( // Makes legend scrollable if list is long
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    mainAxisSize: MainAxisSize.min,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: color,
                                shape: BoxShape.circle, // Circular dots look cleaner
                              ),
                            ),
                            const SizedBox(width: 8),
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: isTop3 ? const Color(0xFF2D5016).withValues(alpha:0.05) : null,
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: ListTile(
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return Container(
                        margin: const EdgeInsets.symmetric(vertical: 4),
                        decoration: BoxDecoration(
                          color: isTop3 ? const Color(0xFFFFC107).withValues(alpha:0.1) : null,
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: ListTile(
                          contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
                          leading: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: isTop3
                                  ...
                                  : null,
                              color: isTop3 ? null : const Color(0xFF2D5016).withValues(alpha:0.1),
                              shape: BoxShape.circle,
                              border: Border.all(
                            ...
                            child: Center(
                              // FIX: Removed Expanded from inside Center
                              child: Text(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: isActive ? Colors.transparent : const Color(0xFF2D5016).withValues(alpha:0.2),
                ),
              ),
              child: Text(
                label,
